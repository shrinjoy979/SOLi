                    ...
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col gap-2">
                        <NavLink
                          to="/"
                          className={({ isActive }) => 
                            `flex items-center gap-3 px-3 py-2 ${isActive ? "rounded-full bg-gray-200 dark:bg-[#293038]" : ""}`
                          }
                        >
                          <div className="text-gray-700 dark:text-white" data-icon="ChartBar" data-size="24px" data-weight="fill">
                          ...
                          <p className="text-gray-700 dark:text-white text-sm font-medium leading-normal">Overview</p>
                        </NavLink>
                        ...
                        >
                          <div className="text-gray-700 dark:text-white" data-icon="List" data-size="24px" data-weight="regular">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                              <path
                          ...
                          <p className="text-gray-700 dark:text-white text-sm font-medium leading-normal">Request Airdrop</p>
                        </NavLink>
                        ...
                        >
                          <div className="text-gray-700 dark:text-white" data-icon="ArrowUp" data-size="24px" data-weight="regular">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                              <path
                          ...
                          <p className="text-gray-700 dark:text-white text-sm font-medium leading-normal">Send Tokens</p>
                        </NavLink>
                        ...
                        >
                          <div className="text-gray-700 dark:text-white" data-icon="ArrowDown" data-size="24px" data-weight="regular">
                          ...
                          <p className="text-gray-700 dark:text-white text-sm font-medium leading-normal">Sign Message</p>
                        </NavLink>
                        ...
                        >
                          <div className="text-gray-700 dark:text-white" data-icon="ArrowCircleUp" data-size="24px" data-weight="regular">
                            <svg
                          ...
                          <p className="text-gray-700 dark:text-white text-sm font-medium leading-normal">Create Token</p>
                        </NavLink>
                        ...
                        >
                          ...
                          <p className="text-gray-700 dark:text-white text-sm font-medium leading-normal">Swap</p>
                        </NavLink>
                      </div>
                    </div>
                  </div>
